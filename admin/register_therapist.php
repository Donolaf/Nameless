...
<html lang="en">
  ...
  <body>
                ...
                <div class="col s12 m12 text-lighten-4">
                  ...
                  <form method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="" id="phone">
                    </div>
                    <div class="form-group">
                      <label>Select Area Of Specialization</label>
                    ...
                    <div class="form-group">
                      <button type="button" class="btn btn-success" onclick="saveTherapist();">Save</button>
                    </div>
                  </form>
                </div>
    ...
    <script>
      ...
      //     $.ajax({
      //       type: "GET",
      //       url:"../__factory/get_stype.php",
      //       cache:false,
      //       success:function(response){
      //         // $("#stype").(res);
      //         alert(response);
      //         // $(".stypes").empty();
      //         $("#theType").append(response);
      //       }
      //     })
      // });
      function saveTherapist()
      {
        ...
        $.ajax({
          type: "POST",
          url:"../__factory/save_therapist.php",
          data:{
            fullname:fullname,
            email:email,
            phone:phone,
