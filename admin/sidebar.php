          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold">
                  <a href="register_type.php" class="waves-effect waves-cyan">
                      <i class="material-icons">cast</i>
                      <span class="nav-text">Area of Specialization</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="register_therapist.php" class="waves-effect waves-cyan">
                      <i class="material-icons">cast</i>
                      <span class="nav-text">Register Therapist</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="news_feeds.php" class="waves-effect waves-cyan">
                      <i class="material-icons">cast</i>
